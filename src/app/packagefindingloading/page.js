...
import './packagefindingloading.css';





const PackageFindingLoading = () => {
  return (
            ...
            <div className='row loading-area-row w-100'>
                <div className='col-12 loading-area-col cent fd-col'>
                    <Image
                        ...
                        height={138}
                        alt='loading image' />
                        <p><strong>Finding Perfect Packages</strong></p>
                        <p>Searching the best vacation packages for you...</p>
                </div>
            </div>
        </div>
    </section>
...
export default PackageFindingLoading 