...
const FlightBookingPending = () => {
    return (
        <section className='flightbooking-pending'>
            <div className='container flightbookingpage-container start fd-col common-gap'>
                <div className='row flightbookingpage-btyperow flight-booking-commonrow flight-booking-commonrow w-100'>
                    <div className='col-12 flightbookingpage-btypecol cent fd-col flightbooking-confirmed-col'>
                        <Image
                            src='/images/final-flight-booking/booking-pending.webp'
                            className='img-fluid'
                            width={276}
                            height={276}
                            alt='flight booking' />
                ...
                <div className='row flight-booking-paysummary cent w-100 flight-booking-commonrow'>
                    ...
                    <div className='col-3 flight-booking-paysummary-coltwo cent'>
                        <Image
                            src='/images/final-flight-booking/pending.webp'
                            className='img-fluid'
                            width={360}
                            height={280}
                            alt='flight booking' />
                ...
                <div className='row flightbooking-confirmed-button-rows start w-100'>
                    <div className='col-12 flightbooking-confirmed-button-colthree'>
                        <div className='flightbooking-confirmed-button-colthree-box cent fd-col text-center w-100'>
                            <p>Your booking be confirmed shortly. Please do not refresh this page.</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default FlightBookingPending 