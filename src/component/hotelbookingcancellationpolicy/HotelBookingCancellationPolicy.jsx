    ...
    return (
        <div className='row hotel-booking-cancellation w-100'>
            <div className='col-12 hotel-booking-cancellation-col start fd-col'>
                <div className='hotel-booking-cancellation-heading start fd-col'>
                    <Image
                ...
                <p className='hotel-booking-cancellation-dis'>Note: Refunds will be processed within 7-10 business days to the original payment method. Some airlines and hotels may have different cancellation policies.</p>
            </div>
        </div>
    )
}
