...
import './FlightBookingMultipleFlightDetail.css'

const FlightBookingMultipleFlightDetail = () => {
    ...
    return (
        <div className="flight-booking-policy w-100 start fd-col flight-booking-commonbox">
            ...
            <div className="row flight-booking-policy-row start w-100 fbcommon-row-padding fbooking-multi-flight">
                <div className="col-12 flight-booking-policy-colone start">
                    <p><strong>Departing Flight</strong></p>
                </div>
                <div className="col-sm-6 flight-booking-policy-coltwo start fd-row">
...
export default FlightBookingMultipleFlightDetail